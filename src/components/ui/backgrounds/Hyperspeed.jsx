      ...
      init() {
        ...
        if (parentContainerId) {
          ...
          if (parent) {
            ...
            parent.addEventListener('mouseout', this.onMouseUp);
            parent.addEventListener('touchstart', this.onTouchStart, { passive: true });
            parent.addEventListener('touchend', this.onTouchEnd, { passive: true });
            parent.addEventListener('touchcancel', this.onTouchEnd, { passive: true });
          }
        } else {
